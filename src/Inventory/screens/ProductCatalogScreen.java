...
public class ProductCatalogScreen {
	...
	private static ProductCatalog createProduct(int product_id) {
		...
		manufacture = Inventory.program.Util.readStringFromUser();
		...
		ProductCatalog product = new ProductCatalog(product_id, name, manufacture, minAmount, mainCat, subCat, ssubCat);
		return product;
	}
